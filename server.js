...
/* ===== TAMBAHAN ROUTES YANG KAMU MINTA ===== */

app.get("/tentang", (req, res) => {
  res.sendFile(
    path.join(__dirname, "views/tentang.html")
  );
});

app.get("/gejala", (req, res) => {
  res.sendFile(
    path.join(__dirname, "views/gejala.html")
  );
});

app.get("/konsultasi", (req, res) => {
  res.sendFile(
    path.join(__dirname, "views/konsultasi.html")
  );
});

app.get("/hasil", (req, res) => {
  res.sendFile(
    path.join(__dirname, "views/hasil.html")
  );
});
